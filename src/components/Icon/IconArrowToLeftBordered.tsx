import {IconArrowToLeftBordered as IconArrowToLeftBorderedInterface} from "./models/IconArrowToLeftBordered";

export default function IconArrowToLeftBordered(props: IconArrowToLeftBorderedInterface) {
